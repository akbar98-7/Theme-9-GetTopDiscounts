...
import P1 from '@theme1/Pages/Events/page';
import P2 from '@theme2/Pages/Events/page';
import P3 from '@theme3/Pages/Events/page';
import P4 from '@theme4/Pages/Events/page';
...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        ...
        alternates: {
            canonical: `https://${companyDomain.domain}/events`,
        },
        openGraph: {
...
const page = async () => {
    ...
    const SelectedPage = selector("theme 8");
    return <SelectedPage />
}
