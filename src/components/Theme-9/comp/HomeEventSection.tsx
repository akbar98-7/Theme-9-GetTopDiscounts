...
import { ScaleReveal } from './MotionWrapper'; // Naya wrapper import karein
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div className="max-w-4xl">
                        <ScaleReveal>
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tighter mb-4">
                                <span className="text-[#2ECC71]">{firstHalf}</span>
                    ...
                    <ScaleReveal delay={0.3}>
                        ...
                        >
                            <span className="absolute inset-0 translate-y-full bg-gradient-to-r from-[#2ECC71] to-[#2ECC71] transition-transform duration-500 ease-out group-hover:translate-y-0" />
