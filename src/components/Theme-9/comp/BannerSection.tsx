  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center bg-[#0a0a0c] text-white overflow-hidden pt-20 pb-10">
      ...
      {bubbles.map((deal, i) => (
        ...
        >
          {/* Merchant Name */}
          <span className="text-[11px] font-black text-[#2ECC71] uppercase tracking-[0.2em] mb-1">
            {deal.name}
          </span>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        >
          ...
          <span className="text-xs md:text-sm font-bold text-[#2ECC71] uppercase tracking-widest">
        ...
        >
          The future of <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r bg-[#2ECC71] from-[#2ECC71] via-[#2ECC71] to-[#2ECC71]">
            smart savings.
          </span>
        </motion.h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="group relative px-5 py-4 bg-[#2ECC71] text-white rounded-full font-black text-sm uppercase tracking-widest hover:scale-105 transition-all duration-300">
            Get Started
          </button>
