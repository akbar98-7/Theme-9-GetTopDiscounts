                ...
                <div className="mb-16">
                    ...
                    <Reveal x={-30} y={0}>
                        <div className="flex items-center gap-3 mb-4">
                            <span className="h-[2px] w-12 bg-[#FFFFFF]"></span>
                            <span className="text-[#2ECC71] font-bold uppercase tracking-[0.3em] text-xs">Verified Savings</span>
                        </div>
                        <h2 className="text-4xl md:text-6xl font-black text-white leading-tight mb-6">
                            {firstHalf || "Today's"} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2ECC71] to-[#2ECC71]">{secondHalf || "Deals"}</span>
                        </h2>
                    </Reveal>
