              ...
              <div className="animate-in fade-in slide-in-from-left-2 duration-500 delay-75">
                <div className="flex items-center justify-between mb-3 px-2">
                   <h3 className="flex items-center gap-2 text-sm font-bold text-slate-400 uppercase tracking-widest">
                    <FaStore className="text-[#FFFFFF]" /> Stores
                  </h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {merchantData.map((merchant, i) => (
                    <Link
                      ...
                      className="no-underline flex items-center gap-3 p-3 rounded-2xl bg-slate-50 hover:bg-[#2ECC71] transition-all group border border-transparent hover:shadow-lg hover:shadow-blue-200"
                    >
                ...
                <div className="flex flex-wrap gap-2 px-2">
                  {categoriesData.map((category, i) => (
                    <Link
                      ...
                      className="no-underline text-slate-600 px-4 py-2 bg-slate-100 rounded-xl text-xs font-bold hover:bg-[#2ECC71] hover:text-white transition-all hover:-translate-y-0.5"
                    >
                      {category.name}
                    </Link>
                  ))}
