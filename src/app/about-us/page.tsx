...
import P1 from '@theme1/Pages/About-Us/page';
import P2 from '@theme2/Pages/About-Us/page';
import P3 from '@theme3/Pages/About-Us/page';
import P4 from '@theme4/Pages/About-Us/page';
import P5 from '@theme5/Pages/About-Us/page';
import P6 from '@theme6/Pages/About-Us/page';
import P8 from '@theme8/Pages/About-Us/page';
import P9 from '@theme9/Pages/About-Us/page';
import { getBaseImageUrl } from '@/constants/hooks';
import { Metadata } from 'next';

export async function generateMetadata(): Promise<Metadata> {
  const companyDomain = await cookieService.get("domain");
  const formattedData = JSON.stringify(["about-us"]);
  const meta = (
  ...
  return {
    ...
    alternates: {
      canonical: `https://${companyDomain.domain}/about-us`,
    },
    openGraph: {
