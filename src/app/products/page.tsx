...
import P1 from '@theme1/Pages/Products/page';
import P2 from '@theme2/Pages/Products/page';
import P3 from '@theme3/Pages/Products/page';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const formattedData = JSON.stringify(["brand-product-page"]);
  const meta = (
  ...
  return {
    ...
    alternates: {
      canonical: `https://${companyDomain.domain}/products`,
    },
    openGraph: {
